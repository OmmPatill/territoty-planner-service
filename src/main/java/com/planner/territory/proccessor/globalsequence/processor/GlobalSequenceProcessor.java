 ...
 *
 *         GlobalSeuenceProcessor find out optimum sequence of locations route.
 *
 */

@Slf4j
@Component(value = "GlobalSequenceFinder")
public class GlobalSequenceProcessor {
	...
	public GlobalSequenceOutputDataModel process(GlobalSequenceInputDataModel globalSequenceFinderModel)
		...
		List<Customer> distanceCust = new ArrayList<>(customerList);//Lists.immutable.ofAll(customerList)
		if (startPoint != null) {
